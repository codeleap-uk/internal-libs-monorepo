...
export type AlwaysPromise<T> = T extends Promise<any> ? T : CancellablePromise<T>
...
export type CallableQuery<R, T> = R extends 
  (routeArgs:RouteArgs<T, any>, ...params: infer A) => 
...
export type Query<T, Err, R extends RoutesOf<T, Err>[string]> = QueryState<Err> & QueryControllers<T, R>
