...
export type DebugColors = {
  [Property in keyof typeof foregroundColors as `${Lowercase<string & Property>}`] : (...args:LogFunctionArgs) => void
}
export type DebugColor = keyof DebugColors
export type LogToTerminalArgs = [logType:LogType, args:LogFunctionArgs, color?:keyof DebugColors]
...
export type SentryProvider = Pick<typeof Sentry, 'addBreadcrumb'|'captureException'|'init'|'captureMessage'>
