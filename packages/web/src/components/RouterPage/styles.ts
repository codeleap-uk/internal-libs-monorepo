...
export type MenuComposition =
  ...
  | 'menuItem:icon:mobile'
  | 'menuItem:icon:mobile:selected'
...
const presets = includePresets((styles) => createRouterPageStyle(() => ({ topMenu: styles, sideMenu: styles })),
)

export const RouterPageStyles = {
  ...presets,
