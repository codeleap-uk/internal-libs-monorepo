...
export type MultiSelectComposition =
  | `${MultiSelectParts}:hover`
  | `${MultiSelectParts}:open`
  | `${MultiSelectParts}:error`
  | `${MultiSelectParts}:disabled`
  | MultiSelectParts

const createSelectStyle = createDefaultVariantFactory<MultiSelectComposition>()
