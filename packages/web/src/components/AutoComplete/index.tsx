...
import { StylesConfig, SelectComponentsConfig, Props } from 'react-select'
...
export const AsyncReactSelect = (props: Props) => {
  return (
    <AsyncSelect {...props} />
  )
}

export const AutoComplete: React.FC<AutoCompleteProps> = ({ accessible, variants, validate, styles, label, onValueChange, ...props }) => {
