import { createDefaultVariantFactory, includePresets, useComponentStyle } from "@codeleap/common";

export type PagerComposition = 'page' | 'page:transition' | 'page:pose:previous' | 'page:pose:next' | 'page:pose:current' | 'wrapper'
