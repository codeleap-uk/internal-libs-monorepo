...
To start off, read about the [motivation for React Query](https://tanstack.com/query/v4/docs/overview), and [why it does not replace redux entirely](https://tanstack.com/query/v4/docs/guides/does-this-replace-client-state).
