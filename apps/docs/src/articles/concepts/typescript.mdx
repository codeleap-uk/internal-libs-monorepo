...
const a:VariantProp = 'round' // No error

const b:VariantProp = 'triangle' // Error, since triangle is not a member of the VariantProp Union
...
const  a:VariantList = ['square','circle'] // Success
const  b:VariantList = ['triangle','circle'] // Error, since triangle is not a member of the VariantProp Union
